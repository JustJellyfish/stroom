...
public class HdfsWriteReadPerformanceTest {
    public static void main(String[] args) {
        HdfsUtil.runAs(() -> {
            try {
                ...
                HdfsDirectory hdfsDirectory = new HdfsDirectory(configuration, new Path("hdfs://hdfs:9000/index"));
                Directory directory = new BlockCacheDirectoryFactoryV2(configuration, 1000000).newDirectory(
